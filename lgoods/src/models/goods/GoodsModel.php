...
class GoodsModel extends Model{
    ...
    public static function formatOne($data, $params = []){
        ...
        $data['g_m_img_url'] = $fModel->buildFileUrlFromArr(FileModel::parseQueryId(ArrayHelper::getValue($data, 'g_m_img_id', '')));
        $data['g_m_img_url1'] = $fModel->buildFileUrlFromArr(FileModel::parseQueryId(ArrayHelper::getValue($data, 'g_m_img_id1', '')));
        $data['g_m_img_url2'] = $fModel->buildFileUrlFromArr(FileModel::parseQueryId(ArrayHelper::getValue($data, 'g_m_img_id2', '')));
