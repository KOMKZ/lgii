...
use ldebug\controllers\UserController;
use ldebug\models\search\UserSearchInterface;
use ldebug\models\UserSwitch;
use ldebug\Panel;
...
class UserPanel extends Panel
{
    ...
    public function init()
    {
        ...
        if (!is_object($this->filterModel)
            ...
            && in_array('ldebug\models\search\UserSearchInterface', class_implements($this->filterModel), true)
        ) {
            ...
            if (is_subclass_of($this->getUser()->identityClass, 'yii\db\ActiveRecord')) {
                $this->filterModel = new \ldebug\models\search\User();
            }
        }
    }
