...
namespace ldebug\models\search;

use ldebug\controllers\DefaultController;
use yii\data\ActiveDataProvider;
use yii\data\ArrayDataProvider;
use ldebug\components\search\Filter;
...
class Debug extends Base
{
     ...
     */
    public function search($params, $query, $db)
    {
        ...
        foreach($models as $key => $item){
            $models[$key] = DefaultController::formatIndexData($item);
        }
