...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'ldebug\controllers';
    /**
     * @var LogTarget
     */
    public $logTarget;
    ...
    public $dataTable = "{{%log_data}}";

    public $indexTable = "{{%log_index}}";
    ...
    {
        return [
            'config' => ['class' => 'ldebug\panels\ConfigPanel'],
            'request' => ['class' => 'ldebug\panels\RequestPanel'],
            'log' => ['class' => 'ldebug\panels\LogPanel'],
            'profiling' => ['class' => 'ldebug\panels\ProfilingPanel'],
            'db' => ['class' => 'ldebug\panels\DbPanel'],
            'event' => ['class' => 'ldebug\panels\EventPanel'],
            'assets' => ['class' => 'ldebug\panels\AssetPanel'],
            'mail' => ['class' => 'ldebug\panels\MailPanel'],
            'timeline' => ['class' => 'ldebug\panels\TimelinePanel'],
            'user' => ['class' => 'ldebug\panels\UserPanel'],
            'router' => ['class' => 'ldebug\panels\RouterPanel'],
        ];
    }
